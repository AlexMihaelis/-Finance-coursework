...
public partial class IncomePage : ContentPage
{
    ...
    public IncomePage(ICategoryServise categoryServise, IMyBudgetServise myBudgetServise)
    {
        InitializeComponent();
        _myBudgetServise = myBudgetServise;

        _categories = categoryServise.GetIncomeCategories();
    }
    ...
    {
        var operations = _myBudgetServise.GetIncomeOperations();
